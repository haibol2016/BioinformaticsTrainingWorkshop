...
df <- read_excel("1.3.lib.meta.add.combined.FASTQC.summary-2.xlsx", 
                            sheet = 1, 
                            skip = 4)
```
  ii) openxlsx Package  
...
library("openxlsx")
df <- read.xlsx("1.3.lib.meta.add.combined.FASTQC.summary-2.xlsx", sheet = 1)
```
...
df <- data.frame(a=c(2,3,5,8,12),b=c(3,8,NA,5,9),c=c(10,4,6,11,15),d=c(22,41,26,31,54))

df
df[!complete.cases(df),]

# The function na.omit() remove rows containing missing value(s).
