...
## Differences between expression versus statement  
...
A general rule of thumb: If you can print it, or assign it to a variable, it's an expression. If you can't, it's a statement.
...
1. **if-else** statement  
**Attention**:  
* Curly brace after **else** must be in the same line as **else**.  
